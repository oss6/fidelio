  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        <Link href="/">
          <a className="text-xl font-bold tracking-tight font-display text-black">
        ...
        <div className="hidden md:flex items-center gap-10">
          <NavLinks />
          <Button onClick={() => scrollToSection("contact")} className="bg-black hover:opacity-80 text-white rounded-full px-8 py-6 text-base">
            Book a Call
          </Button>
        </div>
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[300px] bg-white border-l border-[#E5E4E2]">
              <div className="flex flex-col gap-6 mt-10">
                <NavLinks mobile />
                <Button onClick={() => scrollToSection("contact")} className="w-full bg-black text-white rounded-full py-6">
                  Book a Call
                </Button>
              </div>
            </SheetContent>
