...
export default function Testimonials() {
  return (
    <section id="testimonials" className="py-32 bg-light-elevated border-b border-[#E5E4E2] relative overflow-hidden">
      ...
      <div className="container px-6 mx-auto relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-black text-center">Social Proof</h2>
